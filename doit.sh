...
for problem_number in ${problem_list}; do
    ...
    result_dir=../../svrt_dataset/1Million/results_problem_${problem_number}/train/
    result_dir0=../../svrt_dataset/1Million/results_problem_${problem_number}/train/cat_0
    result_dir1=../../svrt_dataset/1Million/results_problem_${problem_number}/train/cat_1
